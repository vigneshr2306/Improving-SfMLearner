#  python3 eval_depth.py --pred_file ../../sfmLearner_checkpoints/outputs/depth_pretrained/model-100280.npy
...
parser.add_argument("--kitti_dir",type=str, default =  '../../TrainingAndValData/Kitti_raw/',  help='Path to the KITTI dataset directory')
...
def main():
    ...
    np.save('../../sfmLearner_checkpoints/outputs/gtdepths',np.array(gt_depths))
